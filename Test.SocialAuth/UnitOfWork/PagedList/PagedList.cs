...
namespace Test.SocialAuth.UnitOfWork.PagedList
{
    using System;
    using System.Collections.Generic;
    using System.Linq;
    ...
    internal class PagedList<TSource, TResult> : IPagedList<TResult>
    {
        ...
        public PagedList(IEnumerable<TSource> source, Func<IEnumerable<TSource>, IEnumerable<TResult>> converter, int pageIndex, int pageSize, int indexFrom)
        {
            ...
            if (source is IQueryable<TSource> querable)
            {
                ...
                var items = querable.Skip((this.PageIndex - this.IndexFrom) * this.PageSize).Take(this.PageSize).ToArray();
            ...
            else
            {
                ...
                var items = source.Skip((this.PageIndex - this.IndexFrom) * this.PageSize).Take(this.PageSize).ToArray();
